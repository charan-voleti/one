...
<head>
    ...
    <title>MyShop — Viral E‑Commerce</title>
    ...
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                ...
                <a class="brand" href="#">
                    <span>Nexus<span class="accent">Trade</span></span>
                </a>
            </div>

            <nav class="main-nav" id="mainNav" aria-label="Primary navigation">
                <ul>
                    <li><a href="#"><em class="fas fa-home"></em> House</a></li>
                    ...
                    <li><a href="#"><em class="fas fa-fire"></em> Fire </a></li>
